...
public class ConteudoService {
    ...
    private static final String CONTEUDO_NAO_ENCONTRADO = "Conteúdo não encontrado";
    ...
    public void update(@Valid ConteudoDTO conteudoDTO  ) {
        ...
        Conteudo conteudo =
                ...
                .orElseThrow(() -> new ServiceException(" Conteúdo  não econtrado pelo Id[%s]", conteudoDTO.getConteId()));
