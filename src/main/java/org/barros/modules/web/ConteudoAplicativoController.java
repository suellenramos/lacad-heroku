...
//    @APIResponse(
//            responseCode = "200",
//            description = "Obtem todos os Conteudos Aplicativos",
//            content = @Content(
...
//    @APIResponse(
//            responseCode = "400",
//            description = "Já existe um Conteúdo e um Aplicativo com esse Id",
//            content = @Content(mediaType = MediaType.APPLICATION_JSON)
//    )
...
//    @APIResponse(
//            responseCode = "204",
//            description = "Conteúdo e Aplicativo e Atualizado",
//            content = @Content(
//                    mediaType = MediaType.APPLICATION_JSON,
//                    schema = @Schema(type = SchemaType.OBJECT, implementation = ConteudoAplicativoDTO.class)
//            )
...
//            throw new ServiceException("O id não corresponde ao Conteúdo e ao Aplicativo");
//        }
